...
namespace EDlib.EDSM
{
    ...
    public class SystemFactions
    {
        ...
        /// <summary>Array of <see cref="Faction" /> in the system.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="SystemFactions" /> class.</summary>
        ...
        public SystemFactions(long id, long id64, string name, string url, ControllingFaction controlFaction, List<Faction> factions)
        {
            ...
            Name = name;
            Url = url;
            ControllingFaction = controlFaction;
            Factions = factions;
