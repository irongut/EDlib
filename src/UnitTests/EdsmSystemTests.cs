...
namespace UnitTests
{
    ...
    public class EdsmSystemTests
    {
        ...
        public async Task StationsWithCancelTest()
        {
            ...
            try
            {
                stations = await systemService.GetStations("Sol", new CancellationTokenSource()).ConfigureAwait(false);
            }
            catch (APIException)
            {
                Assert.Inconclusive("Skipping test due to issue with EDSM API.");
        ...
        public async Task MarketByIdWithCancelTest()
        {
            ...
            try
            {
                gMarket = await systemService.GetMarket(128016640, new CancellationTokenSource()).ConfigureAwait(false);
            }
            catch (APIException)
            {
                Assert.Inconclusive("Skipping test due to issue with EDSM API.");
        ...
        public async Task MarketByNameWithCancelTest()
        {
            ...
            try
            {
                gMarket = await systemService.GetMarket("Sol", "Galileo", new CancellationTokenSource()).ConfigureAwait(false);
            }
            catch (APIException)
            {
                Assert.Inconclusive("Skipping test due to issue with EDSM API.");
        ...
        public async Task ShipyardByIdWithCancelTest()
        {
            ...
            try
            {
                gShipyard = await systemService.GetShipyard(128016640, new CancellationTokenSource()).ConfigureAwait(false);
            }
            catch (APIException)
            {
                Assert.Inconclusive("Skipping test due to issue with EDSM API.");
        ...
        public async Task ShipyardByNameWithCancelTest()
        {
            ...
            try
            {
                gShipyard = await systemService.GetShipyard("Sol", "Galileo", new CancellationTokenSource()).ConfigureAwait(false);
            }
            catch (APIException)
            {
                Assert.Inconclusive("Skipping test due to issue with EDSM API.");
        ...
        public async Task OutfittingByIdWithCancelTest()
        {
            ...
            try
            {
                gOutfit = await systemService.GetOutfitting(128016640, new CancellationTokenSource()).ConfigureAwait(false);
            }
            catch (APIException)
            {
                Assert.Inconclusive("Skipping test due to issue with EDSM API.");
        ...
        public async Task OutfittingByNameWithCancelTest()
        {
            ...
            try
            {
                gOutfit = await systemService.GetOutfitting("Sol", "Galileo", new CancellationTokenSource()).ConfigureAwait(false);
            }
            catch (APIException)
            {
                Assert.Inconclusive("Skipping test due to issue with EDSM API.");
        ...
        public async Task FactionsWithCancelTest()
        {
            ...
            try
            {
                factions = await systemService.GetFactions("Sol", new CancellationTokenSource()).ConfigureAwait(false);
            }
            catch (APIException)
            {
                Assert.Inconclusive("Skipping test due to issue with EDSM API.");
